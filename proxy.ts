...
export async function proxy(request: NextRequest) {
    ...
    // const accessToken = cookieStore.get("accessToken")?.value; // not handle
    ...
    // premium user check: (For premium path & payment path)
    // const subscriptionStatus = await getSubscriptionStatus();
    // const isActive = Boolean(
    //     subscriptionStatus?.success && subscriptionStatus.data?.isSubscribed,
    // );

    // premium user check: (For premium path)
    if (pathname === '/premium') {
        const subscriptionStatus = await getSubscriptionStatus();
    ...
    // premium user check: (For payment path)
    // if (pathname === '/payment') {
    //     const subscriptionStatus = await getSubscriptionStatus();
